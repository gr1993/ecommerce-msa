...
@Schema(description = "관리자 할인 정책 목록 응답")
@Getter
@Builder
public class AdminDiscountPolicyResponse {
    ...
    public static AdminDiscountPolicyResponse from(DiscountPolicy policy) {
        return AdminDiscountPolicyResponse.builder()
