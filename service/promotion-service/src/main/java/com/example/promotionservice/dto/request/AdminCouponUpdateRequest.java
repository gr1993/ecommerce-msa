...
public class AdminCouponUpdateRequest {
    ...
    @Schema(description = "쿠폰 상태 (ACTIVE, INACTIVE, EXPIRED)", example = "ACTIVE")
    @NotBlank(message = "쿠폰 상태는 필수입니다")
    private String status;

    @Builder
    public AdminCouponUpdateRequest(String couponCode, String couponName, String discountType,
