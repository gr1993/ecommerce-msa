...
@Schema(description = "관리자 할인 정책 등록 요청")
@Getter
@NoArgsConstructor
public class AdminDiscountPolicyCreateRequest {
    ...
    @Schema(description = "할인 상태 (ACTIVE, INACTIVE)", example = "ACTIVE")
    @NotBlank(message = "할인 상태는 필수입니다")
    private String status;

    @Builder
    public AdminDiscountPolicyCreateRequest(String discountName, String discountType,
