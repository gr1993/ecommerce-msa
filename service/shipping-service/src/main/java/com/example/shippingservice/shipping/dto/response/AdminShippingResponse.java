...
@Schema(description = "관리자 배송 목록 응답")
@Getter
@Builder
public class AdminShippingResponse {
    ...
    public static AdminShippingResponse from(OrderShipping orderShipping) {
        return AdminShippingResponse.builder()
