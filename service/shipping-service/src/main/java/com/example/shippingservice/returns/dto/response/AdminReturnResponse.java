...
@Schema(description = "관리자 반품 조회 응답")
@Getter
@Builder
public class AdminReturnResponse {
    ...
    public static AdminReturnResponse from(OrderReturn orderReturn) {
        return AdminReturnResponse.builder()
                ...
                .receiverPhone(orderReturn.getReceiverPhone())
                .returnAddress(orderReturn.getReturnAddress())
                .postalCode(orderReturn.getPostalCode())
