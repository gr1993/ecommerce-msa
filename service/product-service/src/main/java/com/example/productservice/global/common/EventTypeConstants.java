...
public final class EventTypeConstants {
	...
	// Kafka Topics - Stock (Compensation)
	...
	// Kafka Type IDs (Consumer의 TYPE_MAPPINGS와 일치해야 함) - Stock
	public static final String TYPE_ID_STOCK_REJECTED = "stockRejectedEvent";
}
